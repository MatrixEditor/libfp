package io.github.test; //@date 27.10.2023
...
public class ExampleBenchmark
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        ICHAProfileContext context = new ExampleProfileContext();
    ...
    public static class ExampleProfileContext implements ICHAProfileContext
    {
        ...
        {
            CHAStrategy strategy = ICHAProfileContext.super.getStrategy();
