package io.github.libfp.cha; //@date 28.10.2023
...
public class CHAProfileStep implements ICHAProfileStep<CHAProfile>
{
    ...
    @NotNull
    protected Collection<? extends IMethod> getInstanceMethods(@NotNull IClass iClass)
    {
        return CHAUtilities.getInstanceMethods(iClass, false);
    }

    @NotNull
    protected Collection<? extends IMethod> getStaticMethods(@NotNull IClass iClass)
    {
