package io.github.libfp.cha; //@date 27.10.2023
...
/**
 * The FieldProfile class represents a profile associated with a field and is
 * used for various operations within the library fingerprinting framework.
 */
