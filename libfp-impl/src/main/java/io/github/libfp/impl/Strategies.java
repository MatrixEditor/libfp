package io.github.libfp.impl; //@date 25.10.2023
...
public final class Strategies
{
     ...
     * @see RollingHashMethodProfile
     * @see RollingHashMethodLayer
     */
    public static CHAStrategy applyRollingHashMethod(@NotNull CHAStrategy base)
    {
        return base.eachMethod(RollingHashMethodProfile.class,
     ...
     */
    public static <T extends ExtendedClassProfile,
    ...
    public static <T extends ExtensibleProfile> Blueprint<T> addWeight(@NotNull Blueprint<T> blueprint)
    {
    ...
    {
        return maximumWeightBipartiteMatching(x -> ((ExtendedClassProfile) x).getMethods());
    }
     ...
     * @param <V>          The type of vertices for the next matching phase.
     * @param <A>          The type of the current matching algorithm.
     * @param <B>          The type of the next matching algorithm.
     *
    ...
    public static <T extends ManagedProfile, U extends IComparable<U>,
            V extends IComparable<V>,
            A extends AbstractGraphMatching<T, U, DefaultWeightedEdge>,
            B extends AbstractGraphMatching<U, V, DefaultWeightedEdge>>
    @NotNull A combine(@NotNull A matching, B nextMatching)
    {
