...
public class CustomProfileExample
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        // certain profiles.
        ILFactory factory = new UniqueFuzzyILFactory();
        IBytecodeNormalizer normalizer = new CallSideNormalizer(factory);
        ...
        ProfileManager manager =
                new ProfileManager(factory, normalizer)
        ...
        // some time.
        CHAProfile profile = new CHAProfile(libScope, manager, strategy);
        ...
        CHAProfile importedProfile = new CHAProfile(
                profileLocation,
                manager,
                strategy
        );
