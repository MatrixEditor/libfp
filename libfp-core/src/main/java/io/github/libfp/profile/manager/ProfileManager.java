...
public class ProfileManager implements ISerializable
{
    ...
    public ProfileManager(IBytecodeNormalizer normalizer)
    {
        this(null, normalizer);
    }

    public ProfileManager(ILFactory ilFactory, IBytecodeNormalizer normalizer)
    {
        with(ilFactory);
        with(IBytecodeNormalizer.class, normalizer);
    }
    ...
    public static @NotNull ProfileManager getInstance(@Nullable ILFactory factory)
    {
     ...
     */
    public IBytecodeNormalizer getNormalizer()
    {
        return getModule(IBytecodeNormalizer.class);
    }
     ...
     * @return The updated {@code ProfileManager} instance.
     */
    public @NotNull ProfileManager with(@NotNull IBytecodeNormalizerFactory factory)
    {
        return with(IBytecodeNormalizer.class, factory.apply(getILFactory()));
    }
            ...
            final @NotNull RetentionPolicy policy)
    {
        ...
        extensions.putIfAbsent(TypeNames.hash(extension.getClass()), extension);
    ...
    public final <T extends IExtension> @NotNull T getExtension(
            ...
            throws IllegalStateException
    {
        final IExtension extension = getExtension(type.getName());
    ...
    {
        return extensions.containsKey(TypeNames.hash(aClass));
    }
}
