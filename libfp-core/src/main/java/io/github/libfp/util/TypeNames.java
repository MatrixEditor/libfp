package io.github.libfp.util; //@date 18.10.2023
...
public final class TypeNames
{
            ...
            @NotNull String className)
    {
        ...
        return cha.lookupClass(TypeReference.findOrCreate(ClassLoaderReference.Application, name));
    }
    ...
    public static @NotNull List<String> getPackages(final @NotNull TypeName name)
    {
