package io.github.libfp.util; //@date 17.10.2023
...
public final class AnalysisScopeBuilder
{
    ...
    private static final Pattern DEX_FILE_PATTERN =
            Pattern.compile("classes[1-9]?\\.dex");
     ...
     */
    @Contract("_ -> this")
    public @NotNull AnalysisScopeBuilder withAndroidFramework(@NotNull String path)
            throws IOException
    {
            ...
            while (entries.hasNext()) {
                ...
                if (DEX_FILE_PATTERN.matcher(zipEntry.getName())
                    ...
                    final String apkName = Path
                            .of(zipFile.getName().replace(".apk", name))
                            .getFileName()
                            .toString();
        ...
        try (ZipFile zipFile = new ZipFile(path)) {
            ...
            if (zipEntry != null) {
                final String name = Path
                        .of(zipFile.getName().replace(".aar", ".jar"))
                        .getFileName()
                        .toString();
            ...
            throws IOException
    {
        ...
        return switch (suffix) {
            ...
            default ->
                    throw new IllegalArgumentException("Unexpected file: " + suffix + " - " + path);
        };
    }
